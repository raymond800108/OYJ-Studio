            ...
            >
              ...
              <div className="relative z-10 w-full max-w-lg rounded-2xl bg-card border border-border shadow-2xl overflow-hidden">
                ...
                <div className="p-5 space-y-4 max-h-[75vh] overflow-y-auto">
                  ...
                  {/* ① Slide tray — draggable grid covering primary + carousel siblings */}
                  <div className="flex gap-4 items-start">
                    <SlideTray
                      ...
                      onReplaceClick={() => replaceFileInputRef.current?.click()}
                      uploadingMedia={uploadingMedia}
                      replaceInputRef={replaceFileInputRef}
                      onReplaceFile={handleReplaceMedia}
                    />
